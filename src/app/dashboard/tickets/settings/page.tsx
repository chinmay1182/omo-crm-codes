            ...
            <div style={{ flex: 1, overflowY: 'auto', padding: '2rem' }} className={scrollStyles.noScrollbar}>
                <div className={styles.statsGrid}>
                    ...
                    <div className={styles.tableContainer} style={{ gridColumn: '1 / -1', marginTop: '1rem' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', background: '#f8fafc', padding: '1.5rem', borderRadius: '20px', border: 'none' }}>
                            <div>
                                <p style={{ margin: '0 0 0.5rem 0', fontWeight: '300', fontSize: '16px', color: '#64748b' }}>Direct Link</p>
                                <code style={{ background: '#fff', padding: '8px 12px', borderRadius: '0', border: '1px solid #cbd5e1', display: 'block', wordBreak: 'break-all', fontSize: '13px' }}>
                            ...
                            <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
                                <a
                                    ...
                                    target="_blank"
                                    className={styles.actionButton}
                                    style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', textDecoration: 'none', fontSize: '14px' }}
                                >
                                    <i className="fa-thin fa-sharp fa-arrow-up-right-from-square" style={{ fontSize: '14px' }}></i>
                                    Open Form
                                </a>
                                ...
                                >
                                    <i className="fa-thin fa-sharp fa-copy" style={{ fontSize: '14px' }}></i>
                                    Copy Link
                                </button>
                                ...
                                <button
                                    ...
                                    className={styles.actionButton}
                                    style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', background: '#25D366', fontSize: '14px', color: '#fff' }}
                                >
                                    <i className="fa-brands fa-whatsapp" style={{ fontSize: '14px' }}></i>                                    Share on WhatsApp
                                </button>
                                ...
                                <button
                                    ...
                                    style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', fontSize: '14px' }}
                                >
                                    <i className="fa-thin fa-sharp fa-envelope" style={{ fontSize: '14px' }}></i>
                                    Share via Email
                                </button>
                                ...
                                <button
                                    ...
                                    style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', fontSize: '14px' }}
                                >
                                    <i className="fa-thin fa-sharp fa-qrcode" style={{ fontSize: '14px' }}></i>
                                    Generate QR Code
                                </button>
                            </div>
                        </div>
                    ...
                    <div className={styles.statCard}>
                        ...
                        <ul style={{ paddingLeft: '0', marginTop: '0', color: '#334155', listStyle: 'none', fontSize: '14px', fontWeight: '300' }}>
